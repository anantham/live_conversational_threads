              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {onToggleFullscreen && (fullscreen ? (
                    // In full screen, a tiny icon was easy to miss — make exit a
                    // clearly labelled, finger-sized control so there's always an
                    // obvious way back out of the subtitle view.
                    <button
                      onClick={onToggleFullscreen}
                      className="flex items-center gap-1 rounded-full border border-gray-300 bg-white px-2.5 py-1 text-[11px] font-medium text-gray-600 transition hover:bg-gray-50 hover:text-gray-800"
