...
Last updated: 2026-07-04 (kept the 2026-07-02 backfill, added ADR-061, and preserved the known numbering gaps/collisions below)
...
| [ADR-061](ADR-061-stt-fallback-as-ordered-engine-list.md) | STT fallback as an ordered engine list | 2026-07-01 | Accepted; implementation gated |
