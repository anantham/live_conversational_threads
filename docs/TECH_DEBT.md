...
| --- | --- | --- | --- |
| lct_python_backend/services/import_pipeline/hierarchy_integrity.py | 320 | Edge-representation detection/cleanup, canonical membership projection, strict synchronization, and optional-tier degradation now share one pure module | Extract faithful/legacy edge representation helpers into `hierarchy_edge_representation.py`; keep membership synchronization and complete-prefix degradation together until a second projection lens lands |
